...
var ValidatorFactory = class _ValidatorFactory {
   ...
   */
  withContext(field) {
    return new _ValidatorFactory(field, this.#bail, this.#dataTypeValidation);
  }
  /**
   * Specify a rule for literal data type validation
   */
  withDataTypeValidator(validation) {
    return new _ValidatorFactory(this.#field, this.#bail, validation);
  }
  /**
   * Toggle bail mode for the validation
   */
  bail(state) {
    return new _ValidatorFactory(this.#field, state, this.#dataTypeValidation);
  }
  /**
